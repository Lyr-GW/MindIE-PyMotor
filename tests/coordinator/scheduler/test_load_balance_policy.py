...
class TestLoadBalancePolicy(unittest.TestCase):
    ...
    def test_select_instance_from_list_lowest_workload(self):
        ...
        inst1 = create_mock_instance(instance_id=1, gathered_workload=create_mock_workload(active_tokens=10.0))
        inst2 = create_mock_instance(instance_id=2, gathered_workload=create_mock_workload(active_tokens=5.0))
        inst3 = create_mock_instance(instance_id=3, gathered_workload=create_mock_workload(active_tokens=15.0))
    ...
    def test_select_instance_from_list_tie_break_first(self):
        ...
        inst1 = create_mock_instance(instance_id=1, gathered_workload=create_mock_workload(active_tokens=5.0))
        inst2 = create_mock_instance(instance_id=2, gathered_workload=create_mock_workload(active_tokens=5.0))
    ...
    def test_select_instance_from_list_with_start_index(self):
        ...
        result = LoadBalancePolicy.select_instance_from_list(instances, role=PDRole.ROLE_P, start_index=1)
        self.assertIs(result, inst2)
    ...
    def test_select_endpoint_from_instance_lowest_workload(self):
        ...
        ep1 = create_mock_endpoint(endpoint_id=1, workload=create_mock_workload(active_tokens=10.0))
        ep2 = create_mock_endpoint(endpoint_id=2, workload=create_mock_workload(active_tokens=5.0))
        ep3 = create_mock_endpoint(endpoint_id=3, workload=create_mock_workload(active_tokens=15.0))
