...
更完整的 FaultManager 流程见 [FaultManager 设计文档](../../developer_guide/fault_tolerance/fault_manager_design.md)。
...
详见 [配置参考](../../user_guide/service_deployment/config_reference.md#26-fault_tolerance_config)。
