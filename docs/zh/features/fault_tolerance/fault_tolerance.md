...
故障按严重程度分为 7 个等级，由原始故障类型映射而来（[cluster_fault_codes.py](https://gitcode.com/Ascend/MindIE-PyMotor/blob/master/motor/controller/fault_tolerance/k8s/cluster_fault_codes.py)）：
...
- **策略代码**：[lingqu_network_recover.py](https://gitcode.com/Ascend/MindIE-PyMotor/blob/master/motor/controller/fault_tolerance/strategy/lingqu_network_recover.py)
