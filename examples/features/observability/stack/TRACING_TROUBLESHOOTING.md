...
| **P2** | pyMotor 未开启 Tracing | `tracer_config.endpoint` 为空时使用 `NoOpTracerProvider`，不上报 span；见 [SERVICE_GUIDE.md §1.4.1](SERVICE_GUIDE.md) |
...
完整操作见 [SERVICE_GUIDE.md §1.4.1](SERVICE_GUIDE.md)。摘要如下。
...
| 文件 | 用途 |
|------|------|
| [SERVICE_GUIDE.md](SERVICE_GUIDE.md) | 栈拉起与 pyMotor Tracing 完整配置步骤 |
| [GRAFANA_GUIDE.md](GRAFANA_GUIDE.md) | Grafana Explore / Tempo 使用说明 |
