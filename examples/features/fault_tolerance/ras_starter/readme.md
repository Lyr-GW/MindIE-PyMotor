...
### 获取ras_starter脚本及其依赖文件

单机[链接](https://gitcode.com/Ascend/MindIE-pyMotor-private/tree/master/examples/fault_tolerance/ras_starter/ras_starter.py)获取最新的ras_starter脚本。

## 部署步骤

1. 登陆master节点，将 **准备软件或数据** 下载的 "ras_starter.py" 脚本上传到 “/examples/deployer” 路径下。

2. （可选）若用户环境变量配置了Coordinator的证书校验，还需要将对应证书放置在 “./examples/deployer/security” 目录，具体调用见下述代码：
