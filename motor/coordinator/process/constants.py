...
# Start order: Mgmt (binds ROUTER/PUB + SHM) -> Obs -> Infer
START_ORDER = [PROCESS_KEY_MGMT, PROCESS_KEY_OBS, PROCESS_KEY_INFERENCE]
# Stop order (reverse): Infer -> Obs -> Mgmt
STOP_ORDER = [PROCESS_KEY_INFERENCE, PROCESS_KEY_OBS, PROCESS_KEY_MGMT]
