...
| 字段 | 示例值 | 说明 |
|---|---|---|
| `MindIE版本` | `3.0.0` | MindIE-Motor 版本号 |
...
MindIE-Motor 官方镜像托管在 AscendHub：
...
> 为提高下载速度，构建时基础镜像可将 `quay.io` 替换为 `quay.nju.edu.cn`。

### 3.0.0 版本 Dockerfile 目录

每个版本/硬件/系统/架构组合均有独立的自闭环 Dockerfile，目录结构参考 [Ascend/cann-container-image](https://github.com/Ascend/cann-container-image)：
